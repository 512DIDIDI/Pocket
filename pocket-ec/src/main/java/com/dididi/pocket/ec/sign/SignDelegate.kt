...
class SignDelegate : PocketDelegate(), View.OnClickListener {
        ...
        when (v.id) {
            ...
            R.id.delegate_sign_sign_up_layout_sign_up -> //注册事件
                if (checkRegisterInputValid()) {
                    RestClient.builder()
                            .url("")
                            .params("", delegate_sign_sign_up_layout_account!!.text!!.toString())
                            .params("", delegate_sign_sign_up_layout_password!!.text!!.toString())
                            .onSuccess {
                            }
                            .build()
                            .post()
                }
            R.id.delegate_sign_sign_in_layout_sign_in -> //登录事件
            {
                ...
                if (nowTime - lastTime > timeInterval) {
                    ...
                    if (checkLoginInputValid()) {
                        RestClient.builder()
                                .url("")
                                .params("", delegate_sign_sign_in_layout_account!!.text!!.toString())
                                .params("", delegate_sign_sign_in_layout_password!!.text!!.toString())
                                .onSuccess { response ->
    ...
    private fun getSignUpAnimation() {
        PocketAnimation.setFlipAnimation(context, delegate_sign_sign_layout,
                delegate_sign_sign_in_layout, delegate_sign_sign_up_layout)
    }
    ...
    private fun getSignUpBackAnimation() {
        PocketAnimation.setFlipAnimation(context, delegate_sign_sign_layout,
                delegate_sign_sign_up_layout, delegate_sign_sign_in_layout)
    }
    ...
    private fun getForgetPasswordAnimation() {
        PocketAnimation.setFlipAnimation(context,
                delegate_sign_sign_layout, delegate_sign_sign_in_layout,
                delegate_sign_forget_password_layout)
    }
    ...
    private fun getForgetPasswordBackAnimation() {
        PocketAnimation.setFlipAnimation(context,
                delegate_sign_sign_layout, delegate_sign_forget_password_layout,
                delegate_sign_sign_in_layout)
    }
    ...
    private fun getForgetPasswordNextAnimation() {
        PocketAnimation.setFlipAnimation(context,
                delegate_sign_sign_layout, delegate_sign_forget_password_layout,
                delegate_sign_reset_password_layout)
    }
    ...
    private fun getResetPasswordBackAnimation() {
        PocketAnimation.setFlipAnimation(context,
                delegate_sign_sign_layout, delegate_sign_reset_password_layout,
                delegate_sign_forget_password_layout)
    }
    ...
    private fun getEnterSignAnimation() {
        ...
        PocketAnimation.setMoveDelayAnimation(PocketAnimation.TRANSLATION_Y,
                ...
                500L, 100L, 500L, delegate_sign_sign_layout, delegate_sign_dididi_studio)
        //登录信息页面依次从右往左出现
