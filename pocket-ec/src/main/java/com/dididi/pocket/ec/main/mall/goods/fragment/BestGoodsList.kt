...
import kotlinx.android.synthetic.main.item_mall_goods_best.*
...
class BestGoodsList : PocketDelegate(), BaseQuickAdapter.OnItemChildClickListener, BaseQuickAdapter.OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        item_mall_goods_best_recycler_view?.layoutManager = manager
        mAdapter = GoodsAdapter(R.layout.item_mall_goods_list, mGoodsList)
        mAdapter!!.onItemChildClickListener = this
        mAdapter!!.onItemClickListener = this
        item_mall_goods_best_recycler_view?.adapter = mAdapter
    }
