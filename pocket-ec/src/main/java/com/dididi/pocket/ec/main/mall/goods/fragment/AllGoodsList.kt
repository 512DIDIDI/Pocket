...
class AllGoodsList : PocketDelegate(), BaseQuickAdapter.OnItemChildClickListener, BaseQuickAdapter.OnItemClickListener {
    ...
    override fun onBindChildView(savedInstanceState: Bundle?, rootView: View?) {
        ...
        val allGoodsView = rootView!!.findViewById<RecyclerView>(R.id.item_mall_goods_all_recycler_view)
        allGoodsView.layoutManager = manager
        mAdapter = GoodsAdapter(R.layout.item_mall_goods_list, mGoodsList)
        mAdapter!!.onItemChildClickListener = this
        mAdapter!!.onItemClickListener = this
        allGoodsView.adapter = mAdapter
    }
